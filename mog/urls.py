...
urlpatterns = [
    ...
    url(r'^contest/manage/guest/(?P<contest_id>[0-9]+)$', views.manage_csv_guest, name='manage_csv_guest'),
    url(r'^contest/manage/epc/(?P<contest_id>[0-9]+)$', views.manage_csv_epc, name='manage_csv_epc'),
    url(r'^contest/manage/password/(?P<contest_id>[0-9]+)$', views.manage_team_password, name='manage_team_password'),
