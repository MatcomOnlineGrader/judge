...
def report_clarification(clarification):
    ...
    judges = set(
        ...
        for permission in models.ContestPermission.objects.filter(
            contest=clarification.contest, role="judge", granted=True
        )
    )
