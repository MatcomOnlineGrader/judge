...
class ZipTeamPassword:
    ...
    def get_groups(self):
        ...
        for instance in instances:
            ...
            p_instance.institution = instance.institution.name if instance.institution and instance.institution.name else 'Unknown Institution'
            p_instance.group = instance.group
            p_instance.country = instance.institution.country if instance.institution and instance.institution.country else 'Unknown Country'
        ...
        teams = sorted(self.teams, key = lambda x: (x.institution == 'Unknown Institution', x.institution, x.user))
