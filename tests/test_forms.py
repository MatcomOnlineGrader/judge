...
class ContestFormTestCase(TestCase):
    def test_start_and_end_dates(self):
        data = [
            ...
            ('2018-01-01 12:00:00', '2018-01-01 10:00:00', False),  # ends two hours before starts
            ('2018-01-01 12:00:00', '2018-01-01 11:59:59', False),  # ends one second before starts
            ('2018-01-01 00:00:00', '2018-01-02 00:00:00', True),   # one day after
            ('2017-12-31 00:00:00', '2018-01-01 00:00:00', True),   # one day after (end year)
    ...
    def test_frozen_and_death_time(self):
        ...
        for frozen_time, death_time, valid in data:
            ...
            msg = 'Expected %s form, got %s instead for froze_time=%s & death_time=%s' % (
                ['invalid', 'valid'][valid],
                ['invalid', 'valid'][not valid],
                frozen_time,
                death_time
