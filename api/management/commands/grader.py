...
def get_cmd_for_language_safeexec(
    ...
    if lang == "java":
        ...
        memory_limit = memory_limit * 1024 + 529862656
        return f"safeexec --nproc 20 --mem {memory_limit} --cpu {time_limit} --exec /usr/bin/java -Dfile.encoding=UTF-8 -XX:+UseSerialGC -Xms32m -Xmx{memory_limit*1024}M -Xss64m -DMOG=true Main"
    elif lang == "kotlin":
