...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('-c', '--contest_code', type=str, dest='code', help='Contest code')
        parser.add_argument('-n', '--no_granted', action='store_true', dest='no_granted', default=False)
